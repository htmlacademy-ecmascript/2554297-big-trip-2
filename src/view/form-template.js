...
// export function createFormTemplate(event, destinationModel, offerModel) {
//   const { basePrice = '', dateFrom = '', dateTo = '', destination = null, type = 'flight', offers: selectedOfferIds = [] } = event;
